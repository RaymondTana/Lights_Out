...
interface GameState {
  ...
  type GameVariant = 'row-col' | 'adjacent' | 'diagonal';
  ...
  class ColorFlipGame {
    ...
    private gridSizeSlider: HTMLInputElement;
    private sizeValueSpan: HTMLElement;
    private variantSelect: HTMLSelectElement;
    private moveCountSpan: HTMLElement;
    private gameInstructions: HTMLElement;
    private gameOverScreen: HTMLElement;
    private resultText: HTMLElement;
    private resultDetails: HTMLElement;
    ...
    constructor() {
      ...
      this.gridSizeSlider = document.getElementById('grid-size') as HTMLInputElement;
      this.sizeValueSpan = document.getElementById('size-value')!;
      this.variantSelect = document.getElementById('game-variant') as HTMLSelectElement;
    ...
    private updateInstructions(): void {
      const variant = this.variantSelect.value as GameVariant;
    ...
    public setupNewGame(): void {
      ...
      this.state.variant = this.variantSelect.value as GameVariant;
    ...
    private initializeSolvableBoard(): void {      
    ...
    // Enact the click
    private applyMove(row: number, col: number, countMove: boolean): void {
    ...
    private flipSameRowAndColumn(clickedRow: number, clickedCol: number): void {
    ...
    // When Rule is to flip the same row and column
    private flipAdjacents(clickedRow: number, clickedCol: number): void {
      // Flip clicked cell
    ...
    private flipDiagonals(clickedRow: number, clickedCol: number): void {
